jQuery('document').ready(function () {
    ...
    jQuery("#content_fontsize,#template_postContentfontsizeInput,#template_titlefontsize,#template_postTitlefontsizeInput").slider({
        ...
        slide: function (event, ui) {
            jQuery(this).parents('.pbsm-typography-content').find('input.range-slider__value').val(ui.value);
        }
    });
    ...
    var author_title_fontsize = jQuery('#template_titlefontsize').parents('.pbsm-typography-content').find('input.range-slider__value').val()
    ...
    jQuery(".range-slider__value").change(function () {
        ...
        var max = 100;
        if (value > max) {
            jQuery(this).parents('.pbsm-typography-content').find('.range_slider_fontsize').slider("value", '100');
            jQuery(this).val('100');
        } else {
            jQuery(this).parents('.pbsm-typography-content').find('.range_slider_fontsize').slider("value", parseInt(value));
        }
    });
    var post_title_fontsize = jQuery('#template_postContentfontsizeInput').parents('.pbsm-typography-content').find('input.range-slider__value').val()
    jQuery("#template_postContentfontsizeInput").slider("value", post_title_fontsize);
    var post_title_fontsize = jQuery('#template_postTitlefontsizeInput').parents('.pbsm-typography-content').find('input.range-slider__value').val()
    ...
    if (jQuery("input[name='rss_use_excerpt']:checked").val() == 1) {
        ...
        jQuery('.excerpt_length').removeClass('pbsm-hidden');
        jQuery('.read_more_on').removeClass('pbsm-hidden');
        if (jQuery("input[name='readmore_on']:checked").val() == 0) {
            ...
            jQuery('.read_more_text').addClass('pbsm-hidden');
            jQuery('.read_more_text_color').addClass('pbsm-hidden');
            jQuery('.read_more_text_background').addClass('pbsm-hidden');
        } else if (jQuery("input[name='readmore_on']:checked").val() == 1) {
            jQuery('.read_more_text').show();
            jQuery('.read_more_text_color').show();
            jQuery('.read_more_text_background').hide();

            jQuery('.read_more_text').removeClass('pbsm-hidden');
            jQuery('.read_more_text_color').removeClass('pbsm-hidden');
            jQuery('.read_more_text_background').addClass('pbsm-hidden');
        } else {
            jQuery('.read_more_text').show();
            jQuery('.read_more_text_color').show();
            ...
            jQuery('.read_more_text').removeClass('pbsm-hidden');
            jQuery('.read_more_text_color').removeClass('pbsm-hidden');
            jQuery('.read_more_text_background').removeClass('pbsm-hidden');
        }
    } else {
        ...
        jQuery('.excerpt_length').addClass('pbsm-hidden');
        jQuery('.read_more_on').addClass('pbsm-hidden');
        jQuery('.read_more_text').addClass('pbsm-hidden');
        jQuery('.read_more_text_color').addClass('pbsm-hidden');
        jQuery('.read_more_text_background').addClass('pbsm-hidden');
    }
    ...
    jQuery("input[name='template_alternativebackground']").change(function () {
        if (jQuery(this).val() == 0) {
            ...
            jQuery('.alternative-color-tr').removeClass('pbsm-hidden');
        } else {
            jQuery('.alternative-color-tr').hide();
            jQuery('.alternative-color-tr').addClass('pbsm-hidden');
        }
        bdAltBackground();
    });

    if (jQuery("input[name='social_share']:checked").val() != 1) {
        jQuery('.pbsm-social-share-options').hide();
        jQuery('.pbsm-social-share-options').addClass('pbsm-hidden');
    } else {
        jQuery('.pbsm-social-share-options').show();
        jQuery('.pbsm-social-share-options').removeClass('pbsm-hidden');
    }
    ...
    if (jQuery('#template_name').val() == 'default_layout' || jQuery('#template_name').val() == 'timeline' || jQuery('#template_name').val() == 'news_feed') {
        jQuery('.blog-template-tr').hide();
        jQuery('.blog-columns-tr').hide();
        jQuery('.alternative-color-tr').hide();
        jQuery('.hoverbackcolor-tr').hide();
        jQuery('.blog-templatecolor-tr').hide();
        jQuery('.blog-template-tr').addClass('pbsm-hidden');
        jQuery('.alternative-color-tr').addClass('pbsm-hidden');
        jQuery('.pbsm-setting-handle li').each(function () {
            var hide = jQuery(this).attr('data-show');
            if (hide == 'bdpslider') {
                jQuery(this).addClass('clickDisable');
            }
        });
    } else if (jQuery('#template_name').val() == 'grid-layout') {
        jQuery('.pbsm-setting-handle li').each(function () {
            var hide = jQuery(this).attr('data-show');
            if (hide == 'bdpslider') {
                jQuery(this).addClass('clickDisable');
        ...
        jQuery('.blog-template-tr').addClass('pbsm-hidden');
        jQuery('.alternative-color-tr').addClass('pbsm-hidden');
    } else if (jQuery('#template_name').val() == 'center_top') {
        jQuery('.blog-templatecolor-tr').hide();
        jQuery('.blog-template-tr').hide();
        jQuery('.blog-columns-tr').hide();
        jQuery('.blog-templatecolor-tr').hide();
    ...
    else if (jQuery('#template_name').val() == 'default_slider') {
        jQuery('.blog-template-tr').hide();
        jQuery('.blog-columns-tr').hide();
        jQuery('.hoverbackcolor-tr').hide();
        jQuery('.blog-templatecolor-tr').hide();
        ...
        jQuery('.blog-columns-tr').hide();
        jQuery('.blog-template-tr').removeClass('pbsm-hidden');
    ...
    if (jQuery('#template_name').val() == 'timeline') {
        ...
        jQuery('.blog-template-tr').addClass('pbsm-hidden');
        jQuery('.alternative-color-tr').addClass('pbsm-hidden');
        jQuery('.blog-templatecolor-tr').removeClass('pbsm-hidden');
        jQuery('.pbsm-setting-handle li').each(function () {
            var hide = jQuery(this).attr('data-show');
            if (hide == 'bdpslider') {
                jQuery(this).addClass('clickDisable');
    ...
    jQuery('.pbsm-form-class .pbsmp-restore-default').click(function () {
        if (confirm(bdlite_js.reset_data)) {
            var template = jQuery('#template_name').val();
            default_data(template);
            jQuery('form.pbsm-form-class')[0].submit();
        } else {
            return false;
        }
    });
    ...
    jQuery('.post-blog-showcase-manager-panel-list li a').on('click', function (e) {
        e.preventDefault();
        if (jQuery(this).closest('li').hasClass('active')) {
            return;
        }
        jQuery('.post-blog-showcase-manager-panel-list li').removeClass('active');
        jQuery(this).closest('li').addClass('active');
        jQuery('.post-blog-showcase-manager-panel-wrap > div').hide();
        var dateId = jQuery(this).data('id');
        if (jQuery('.post-blog-showcase-manager-panel-wrap > div').hasClass(dateId)) {
            jQuery('.post-blog-showcase-manager-panel-wrap > div.' + dateId).show();
        }
    ...
    jQuery('.create-test-page').on('click', function (e) {
        ...
        jQuery(this).closest('h4.do-create-test-page').css({
            "opacity": "0.5",
            "cursor": "progress"
        })
        jQuery.ajax({
            ...
            url: ajaxurl,
            data: {
                action: 'pbsm_create_sample_layout',
            },
...
jQuery(window).load(function () {
    ...
    var pbsm_plugin_admin = jQuery('.documentation_pbsm_plugin').closest('div').find('.deactivate').find('a');
    jQuery('.pbsm-deactivation').on('click', function () {
        window.location.href = pbsm_plugin_admin.attr('href');
    });
    pbsm_plugin_admin.click(function (event) {
...
jQuery('.pbsm-form-class .pbsm-setting-handle > li').click(function (event) {
    if (jQuery(this).hasClass('clickDisable')) {
        clickDisable();
    } else {
        var section = jQuery(this).data('show');
        jQuery('.pbsm-form-class .pbsm-setting-handle > li').removeClass('pbsm-active-tab');
        jQuery(this).addClass('pbsm-active-tab');
        jQuery('.pbsm-settings-wrappers .postbox').hide();
        jQuery('#' + section).show();
        jQuery.post(ajaxurl, {
            action: 'pbsm_closed_bdboxes',
            closed: section,
            page: 'pbsm_settings'
        });
    }
...
jQuery(document).ready(function () {
    var config = {
        ...
        '.chosen-select-no-results': {
            no_results_text: bdlite_js.nothing_found
        },
        '.chosen-select-width': {
            width: "95%"
        }
    ...
    jQuery('.fa-check').hide();
    jQuery("#pbsm-submit-button").click(function () {
        jQuery('.fa-check').show();
        jQuery(".save_blogdesign").trigger("click");
        bdAltBackground();
    });
    jQuery(".pbsm-settings-wrappers .postbox table tr td:first-child").hover(function () {
        var $parent_height = jQuery(this).height();
        var $height = jQuery(this).children('.pbsm-title-tooltip').height();
        jQuery(this).children('.pbsm-title-tooltip').css('top', 'calc(50% - 30px - ' + $height + 'px)');
    });
        ...
        jQuery("#pbsm_popupdiv").dialog({
            ...
            buttons: [{
                    ...
                    click: function () {
                        ...
                        if (template_value == 'default_layout' || template_value == 'timeline' || template_value == 'news_feed') {
                            jQuery('.blog-template-tr').hide();
                            jQuery('.alternative-color-tr').hide();
                            jQuery('.blog-columns-tr').hide();
                            jQuery('.blog-template-tr').addClass('pbsm-hidden');
                            ...
                            jQuery('.alternative-color-tr').addClass('pbsm-hidden');
                        } else if (template_value == 'grid-layout') {
                            jQuery('.pbsm-setting-handle li').each(function () {
                                var hide = jQuery(this).attr('data-show');
                                if (hide == 'bdpslider') {
                                    jQuery(this).addClass('clickDisable');
                            ...
                            jQuery('.blog-template-tr').addClass('pbsm-hidden');
                            jQuery('.alternative-color-tr').addClass('pbsm-hidden');
                        } else if (template_value == 'default_slider') {
                            jQuery('.blog-template-tr').hide();
                            jQuery('.blog-columns-tr').hide();
                            jQuery('.alternative-color-tr').hide();
                            jQuery('.blog-template-tr').addClass('pbsm-hidden');
                        ...
                        if (template_value == 'timeline') {
                            ...
                            jQuery('.blog-templatecolor-tr').hide();
                            jQuery('.blog-templatecolor-tr').addClass('pbsm-hidden');
                        }
    ...
    jQuery('.pbsm_template_tab li a').click(function (e) {
        e.preventDefault();
        var all_template_hide = true;
        jQuery('.pbsm_template_tab li').removeClass('pbsm_current_tab');
        jQuery(this).parent('li').addClass('pbsm_current_tab');
        var href = jQuery(this).attr('href').replace('#', '');
        jQuery('.pbsm-template-thumbnail').hide();
        if (href == 'all') {
            jQuery('.pbsm-template-thumbnail').show();
        } else {
            jQuery('.' + href + '.pbsm-template-thumbnail').show();
        }
        jQuery('.pbsm-template-thumbnail').each(function () {
    ...
    jQuery('.pro-feature, .pro-feature ul, .pro-feature input, .pro-feature a, .pro-feature .pbsmp-upload_image_button, #pbsm-show-preview').on('click', function (e) {
        e.preventDefault();
        jQuery("#pbsm-advertisement-popup").dialog({
            resizable: false,
            draggable: false,
            modal: true,
            height: "auto",
            width: 'auto',
            maxWidth: '100%',
            dialogClass: 'pbsm-advertisement-ui-dialog',
            buttons: [{
                text: 'x',
                "class": 'pbsm-btn pbsm-btn-gray',
                click: function () {
                    jQuery(this).dialog("close");
                }
            }],
            ...
            close: function (event, ui) {
                jQuery('#pbsm-template-search').val('');
                jQuery("#pbsm-advertisement-popup").dialog('close');
            },
        });
    });
    ...
    jQuery('#pbsm-template-search').keyup(function () {
    ...
    jQuery('.pbsm-template-search-clear').on('click', function () {
        jQuery('#pbsm-template-search').val('');
        var $template_name = '';
        templateSearch($template_name);
    });
...
function templateSearch($template_name) {
    var template_name = jQuery('#template_name').val();
    var $template_cat = jQuery('.pbsm_template_tab').find('.pbsm_current_tab a').attr('href');
    var $all_template_hide = true;
    ...
    jQuery.ajax({
        ...
        method: 'POST',
        data: {
            'action': 'pbsm_template_search_result',
            'temlate_name': $template_name,
        },
        success: function (response) {
            jQuery('.pbsm-template-cover').html(response);
...
function default_data(template) {
    ...
    if (template == "grid-layout") {
        ...
        jQuery("#template_alternativebackground_0").prop("checked", false);
        jQuery("#template_alternativebackground_1").prop("checked", true);
        jQuery('#template_ftcolor').iris('color', '#b3b3b3');
        jQuery('#template_fthovercolor').iris('color', '#333333');
        jQuery('#template_alterbgcolor').iris('color', '#ffffff');
        jQuery("#template_alterbgcolor").val('#ffffff');
        jQuery('#template_titlecolor').iris('color', '#b3b3b3');
        ...
        jQuery('#template_contentcolor').iris('color', '#b3b3b3');
        jQuery("#readmore_on_0").prop("checked", false);
        jQuery("#readmore_on_1").prop("checked", false);
        jQuery("#readmore_on_2").prop("checked", true);
        jQuery('#txtReadmoretext').val('Read More');
        ...
        jQuery('#grid_hoverback_color').iris('color', '#f1f3f3');
    ...
    if (template == 'default_layout') {
        ...
        jQuery("#content_fontsize").val("14");
        jQuery("#posts_per_page").val("5");
        jQuery('#template_contentcolor').iris('color', '#222222');
        ...
        jQuery('#txtReadmoretext').val('Read More');
        jQuery('#template_readmorecolor').iris('color', '#ffffff');
        jQuery('#template_readmorebackcolor').iris('color', '#673bb6');
        jQuery("#social_share_1").prop("checked", true);
        jQuery("#social_share_0").prop("checked", false);
        jQuery("#social_icon_style_1").prop("checked", true);
        jQuery("#social_icon_style_0").prop("checked", false);
    ...
    if (template == 'timeline') {
        ...
        jQuery("#display_comment_count_0").prop("checked", true);
        jQuery("#display_comment_count_1").prop("checked", false);
        jQuery('#template_color').iris('color', '#673bb6');
        jQuery('#template_ftcolor').iris('color', '#673bb6');
...
function pbsm_show_hide_permission() {
    jQuery('.pbsm_permission_cover').slideToggle();
}

function pbsm_submit_optin(options) {
    result = {};
    result.action = 'pbsm_submit_optin';
    result.email = jQuery('#pbsm_admin_email').val();
    result.type = options;

    if (options == 'submit') {
        if (jQuery('input#pbsm_agree_gdpr').is(':checked')) {
            jQuery.ajax({
                url: ajaxurl,
                type: 'POST',
                data: result,
                error: function () {},
                success: function () {
                    window.location.href = "admin.php?page=pbsm_getting_started";
                },
                complete: function () {
                    window.location.href = "admin.php?page=pbsm_getting_started";
                }
            ...
            jQuery('.pbsm_agree_gdpr_lbl').css('color', '#ff0000');
        }
    } else if (options == 'deactivate') {
        if (jQuery('input#pbsm_agree_gdpr_deactivate').is(':checked')) {
            var pbsm_plugin_admin = jQuery('.documentation_pbsm_plugin').closest('div').find('.deactivate').find('a');
